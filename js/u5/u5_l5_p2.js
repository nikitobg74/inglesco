  ...
  const QUESTIONS = [
    {
      ...
      prompt: "👉 Tommy's cat",
      options: [
        { text: "el gato de Tommy", correct: true },
        { text: "Tommy es el gato",  correct: false }
      ],
      feedbackCorrect: "✔ Correcto: <strong>el gato de Tommy</strong>",
      feedbackWrong:   "❌ <em>Tommy es el gato</em> = Tommy is the cat"
    },
    {
